...
public interface Transformer extends Serializable {
   ...
   class ProcessorAdapter implements Transformer, ResourceUtilizer {
      ...
      @Override
      public void before(Session session, ByteBuf output) {
      ...
      @Override
      public void after(Session session, ByteBuf output) {
